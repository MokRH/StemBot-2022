...
//pins output
const int8_t dirL = 2, pwmL = 3, dirR = 4, pwmR = 5, led_r = 13, led_y = 1, led_g = 0, battMon_en = 6;
...
void forward(int left, int right) {
  ...
  analogWrite(pwmL, constrain( (left + offsetL), 0, 255 ));
  analogWrite(pwmR, constrain( (right - offsetR), 0, 255 ));
}
